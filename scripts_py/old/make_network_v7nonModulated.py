    ...
    if do_dcnio:
        ...
        if os.path.exists(dcn_yaml):
            ...
            if 'connectivity' in config_dcn:
                ...
                config_dcn['connectivity']['mossy_fibers_to_dcn_p']['indegree'] = max(1, int(np.round(float(value * k**3), 6)))
                value = config_dcn['connectivity']['purkinje_to_dcn_i']['outdegree']
                config_dcn['connectivity']['purkinje_to_dcn_i']['outdegree'] = max(1, int(np.round(float(value * k**3), 6)))
                value = config_dcn['connectivity']['purkinje_to_dcn_p']['outdegree']
                config_dcn['connectivity']['purkinje_to_dcn_p']['outdegree'] = max(1, int(np.round(float(value * k**3), 6)))
        ...
        if os.path.exists(dcn_io_yaml):
            ...
            if 'connectivity' in config_io:
                ...
                config_io['connectivity']['dcn_i_to_io']['indegree'] = max(1, int(np.round(float(value * k**3), 6)))
                value = config_io['connectivity']['io_to_dcn_p']['outdegree']
                config_io['connectivity']['io_to_dcn_p']['outdegree'] = max(1, int(np.round(float(value * k**3), 6)))
                value = config_io['connectivity']['io_to_dcn_i']['outdegree']
                config_io['connectivity']['io_to_dcn_i']['outdegree'] = max(1, int(np.round(float(value * k**3), 6)))
